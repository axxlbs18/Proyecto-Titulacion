    ...
    <aside class="sidebar border-end d-flex flex-column flex-shrink-0">
        ...
        <nav class="nav nav-pills flex-column p-3">
            ...
            <ul class="nav flex-column">
                <li class="nav-item"><a href="#" class="nav-link active"><i class="bi bi-person-video3"></i> Vista de Empleados</a></li>
                ...
                <li class="nav-item"><a href="#" class="nav-link"><i class="bi bi-file-earmark-person"></i> Solicitudes de Personal</a></li>
            </ul>
        </nav>
